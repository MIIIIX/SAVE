...
async def cbdonate(event):              
    await event.edit("It's pleasure for me that you are donating me for all my efforts and work!", buttons=[Button.url("Donate Now", url="https://buymeacoffee.com/pyrogrammers")])
